...
devin2api (Rust port) depends on the following crates. Licenses are
recorded from the resolved manifests in `Cargo.lock`/`cargo metadata`;
full texts are in each crate's source under the Cargo registry.
...
| connectrpc                   | 0.9.0                         | Apache-2.0                                          |
| connectrpc-build             | 0.9.0                         | Apache-2.0                                          |
| connectrpc-codegen           | 0.9.0                         | Apache-2.0                                          |
